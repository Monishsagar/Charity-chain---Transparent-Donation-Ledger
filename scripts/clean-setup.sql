-- CharityChain Database Clean Setup
-- This script safely creates the schema, dropping and recreating tables as needed

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Drop all existing tables if they exist (in reverse dependency order)
DROP TABLE IF EXISTS impact_attributions CASCADE;
